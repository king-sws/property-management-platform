...
export const metadata = {
  title: "State of Property Management 2025 — Propely",
  description:
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 pt-24 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="font-mono font-medium tracking-wider text-foreground/50 uppercase text-[12px]">2025 Report</span>
          </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          ...
          <div className="rounded-xl border border-border bg-foreground/[0.02] p-6">
            ...
            <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
              <p>This report is based on a survey of 512 independent landlords across the United States, conducted in April–May 2025. Respondents managed between 1 and 150 units, with a median of 6.2 units.</p>
