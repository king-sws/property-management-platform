      ...
      <div className="container max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-3 text-muted-foreground text-base md:text-lg">
            Propely includes built-in document templates so you never have to start from scratch.
          </p>
        </div>
        ...
        <div className="rounded-xl bg-muted/40 p-8 text-center">
          <h3 className="text-lg font-semibold mb-2">All templates included with Propely</h3>
          <p className="text-sm text-muted-foreground mb-4">
            Sign up for a free trial to access every template and start managing your properties today.
          </p>
          <Link
            href="/sign-up"
