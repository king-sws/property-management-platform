...
export const metadata: Metadata = {
  title: 'Privacy Policy | Propely',
  description: 'Our commitment to protecting your privacy and personal information. Learn how we collect, use, and safeguard your data at Propely.',
}
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <div className="space-y-6 mb-12">
              <p className="text-muted-foreground leading-relaxed">
                At Propely, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit propely.site or use our property management services.
              </p>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="rounded-xl bg-muted/50 border border-border p-6 mb-12">
              ...
              <nav className="space-y-2">
                {[
                  ['#information-collection', '1. Information We Collect'],
                  ['#information-use', '2. How We Use Your Information'],
                  ['#information-sharing', '3. Information Sharing and Disclosure'],
                  ...
                  ['#children-privacy', "8. Children's Privacy"],
                  ['#changes', '9. Changes to This Policy'],
                  ['#contact', '10. Contact Us'],
                ].map(([href, label]) => (
                  <a key={href} href={href} className="block text-sm text-muted-foreground hover:text-foreground transition-colors">
                    {label}
                  </a>
                ))}
              </nav>
            ...
            <div id="information-collection" className="space-y-4 mb-10">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-base font-medium text-foreground mb-2">Personal Information</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    We may collect personally identifiable information that you voluntarily provide when you register on the website, use our services, or contact us. This may include:
                  </p>
            ...
            <div id="information-sharing" className="space-y-4 mb-10">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-1">
                <li><strong>Service Providers:</strong> With third-party vendors who perform services on our behalf (payment processing, data analysis, email delivery, advertising)</li>
            ...
            <div id="cookies" className="space-y-4 mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We use cookies, web beacons, and similar tracking technologies to enhance your browsing experience, analyze site traffic, personalize content, and serve relevant advertisements. You can control cookie settings through your browser preferences.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                <strong>Google AdSense:</strong> We use Google AdSense to display advertisements on our site. Google uses cookies (including the DoubleClick cookie) to serve ads based on your prior visits to propely.site and other sites on the internet. You may opt out of personalized advertising by visiting{' '}
                <a
            ...
            <div id="contact" className="space-y-4 mb-10">
              ...
              <div className="rounded-xl bg-muted/50 border border-border p-6 mt-4">
                <ul className="space-y-2 text-muted-foreground">
                  <li>
                    <strong>Email:</strong>{' '}
                    <a href="mailto:privacy@propely.site" className="text-indigo-600 dark:text-indigo-400 hover:underline">
                      privacy@propely.site
                    </a>
                  </li>
                  <li>
                    <strong>Website:</strong>{' '}
                    <a href="https://propely.site" className="text-indigo-600 dark:text-indigo-400 hover:underline">
                      propely.site
                    </a>
                  </li>
                </ul>
            ...
            <div className="rounded-xl border border-border p-6 mt-12">
              ...
              <div className="flex flex-wrap gap-4">
                <a href="/terms" className="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Terms of Service</a>
                <a href="/legal/cookie-policy" className="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Cookie Policy</a>
              </div>
            </div>
          </div>
        </div>
