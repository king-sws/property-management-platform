...
/* ─────────────────────────────────────────────────────────────────────────────
   STARFIELD BACKGROUND  (inline so the file is self-contained)
───────────────────────────────────────────────────────────────────────────── */
    ...
    <StarfieldBackground starCount={140}>
      ...
      <section className="relative w-full py-24 border-t border-white/5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col items-center text-center gap-3 mb-12">
            <p className="font-mono font-medium tracking-wider text-foreground/50 uppercase text-[11px]">REAL MANAGERS</p>
            <h2 className="font-display font-medium text-3xl sm:text-4xl tracking-tighter">Built on their feedback</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {testimonials.map((t, i) => (
              <div key={i} className="rounded-xl border border-white/5 bg-white/[0.02] p-6 flex flex-col gap-5">
                <div className="flex gap-0.5 text-yellow-400">
                  {[...Array(5)].map((_, j) => (
                    <svg key={j} xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
                      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                    </svg>
                  ))}
                </div>
                <p className="text-sm text-foreground/65 leading-relaxed flex-1">"{t.quote}"</p>
                <div className="flex items-center gap-3 pt-3 border-t border-white/5">
                  <Image src={t.avatar} alt={t.name} width={32} height={32} className="w-8 h-8 rounded-full border border-white/10 object-cover" />
                  <div>
      ...
      {/* ── PRICING CTA ───────────────────────────────────────────────────── */}
      <section className="relative w-full py-28 border-t border-white/5">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center flex flex-col items-center gap-7">

          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[11px] font-mono tracking-widest uppercase text-foreground/50">
            14-day free trial · No credit card required
          </div>

          <h2 className="font-display font-medium text-3xl sm:text-5xl lg:text-6xl tracking-tighter text-pretty leading-tight">
            Ready to manage smarter?
          </h2>

          <p className="text-[#b4b4b5] text-base sm:text-lg max-w-[34em]">
            Join hundreds of property managers who replaced spreadsheets, chasing tenants, and late-night invoice emails with Propely.
          </p>
          ...
          <div className="flex items-center gap-2 text-sm flex-wrap justify-center">
            ...
            <span className="inline-flex items-center rounded bg-white/20 px-2 py-0.5 font-mono text-xs font-medium tabular-nums">3 left</span>
          </div>

          <div className="flex flex-col sm:flex-row gap-3">
            <RainbowButton href="/sign-up" large>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 216 251" role="img" aria-label="Logo" className="w-5 h-5 fill-current">
            ...
            <Link href="/#pricing">
              <button className="inline-flex items-center justify-center gap-2 font-medium text-base px-8 py-4 rounded-lg border border-white/10 bg-white/5 text-foreground hover:bg-white/10 transition-colors">
                View pricing
              </button>
            </Link>
          </div>

          <p className="text-xs text-foreground/25 font-mono">All prices in USD · Cancel anytime · Taxes may apply</p>
        </div>
      </section>
