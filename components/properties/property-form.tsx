...
// Property Form Component with Image Upload - UPDATED
// ============================================================================
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // If creating new property, redirect to edit page to add images
        if (!isEditing && result.data?.id) {
          router.push(`/dashboard/properties/${result.data.id}/edit`);
        } else {
