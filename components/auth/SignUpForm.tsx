    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white dark:bg-[#181a1b] px-2 text-slate-500 dark:text-slate-400">Or create account with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {roleOptions.map((option) => {
              ...
              return (
                <button
                  ...
                  `}
                >
                  <Icon className={`w-6 h-6 mb-2 ${isSelected ? 'text-blue-600 dark:text-blue-400' : 'text-slate-400 dark:text-slate-500'}`} />
        ...
        <div className="flex items-start space-x-2">
          <input
            ...
            id="terms"
            type="checkbox"
            className="mt-1 h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-300 dark:border-slate-700 dark:bg-[#181a1b] rounded"
            disabled={isLoading}
          />
